...
const SALAMANDRA_LANGUAGE_IDS = [
  "bg", "ca", "hr", "cs", "cy", "da", "de", "el", "en", "es", "et", "eu",
  "fi", "fr", "gl", "hu", "it", "lt", "lv", "mt", "nl", "nn", "no", "oc",
  "pl", "pt", "ro", "ru", "sk", "sl", "sr", "sv", "uk",
] as const;
...
const SALAMANDRA_FILES: ModelFileSpec[] = [
  hfFile(SALAMANDRA_REPO, "salamandrata_2b_inst_q4.gguf", 1_517_617_504),
];

const MADLAD_REPO = "mtsdurica/madlad400-3b-mt-Q4_K_M-GGUF";
const MADLAD_FILES: ModelFileSpec[] = [
  hfFile(MADLAD_REPO, "madlad400-3b-mt-q4_k_m.gguf", 1_858_124_864),
];
...
const SILERO_FILES: ModelFileSpec[] = [
  hfFile(SILERO_REPO, "onnx/model.onnx", 2_243_022),
];
...
export const ASR_MODELS: AsrModelSpec[] = [
  ...ORT_ASR_MODELS,
  ...SHERPA_ASR_MODELS,
];
